                    ...
                    <View style={styles.icon}>
                        <View style={styles.topa}>
                            <TouchableOpacity onPress={() => {
                                this.props.navigation.navigate("PremiumQuizVue")
                            }}>
                    ...
                    <View style={styles.icon}>
                        <View style={styles.topa}>
                            <TouchableOpacity onPress={() => {
                                ...
                                <Image source={require('../assets/Images/Theme/Premium/Annimaux.png')}/>
                            </TouchableOpacity>
                            <Text style={styles.txt}>
                                Annimaux
                            </Text>
                        ...
                        <View style={styles.topa}>
                            <TouchableOpacity onPress={() => {
                                ...
                                <Image source={require('../assets/Images/Theme/Premium/Nouriture.png')}/>
                            </TouchableOpacity>
                            <Text style={styles.txt}>
                                Nourriture
                            </Text>
